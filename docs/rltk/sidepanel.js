...
document.addEventListener('DOMContentLoaded', () => {
    // The "RLTK on the web" footer link is self-referential when the side panel
    // is already being served from the companion website — hide it there.
    if (/(^|\.)github\.io$/i.test(location.hostname)) {
        const webLink = document.getElementById('rltk-web-link');
