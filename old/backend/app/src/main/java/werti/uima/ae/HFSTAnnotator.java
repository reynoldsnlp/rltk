 ...
 * shallow syntactic parser. Uses HFSTAnalyser to analyse text.
 * 
 * @author Niels Ott?
 * @author Adriane Boyd
 * @author Heli Uibo
 ...
 *
 */
public class HFSTAnnotator extends JCasAnnotator_ImplBase {
    @ExternalResource
	...
	private HFSTAnalyser hfstAnalyser;
	...
	public void process(JCas jcas) throws AnalysisEngineProcessException {
		...
		try {
            // analyse tokens
            String analyses = hfstAnalyser.runTransducer(originalTokens);
